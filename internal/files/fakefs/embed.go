...
func (f *embedFile) Info() filesystem.FileInfo { return f.info }
...
func (d *embedDirectory) Walk(fn func(filesystem.File, error) error) error {
...
func (efs *EmbedFileSystem) Open(openPath string) (filesystem.Directory, error) {
...
func (efs *EmbedFileSystem) Stat(statPath string) (filesystem.FileInfo, error) {
	// Normalize path to forward slashes
