...
func TestResolveConnection_WithEnvironment(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			connConfig, _, err := resolveConnection(tt.connStringFlag, tt.granularFlags, nil, nil, nil, false)
...
func TestResolveConnection_GranularFlags(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			connConfig, _, err := resolveConnection("", tt.granularFlags, nil, nil, nil, false)
