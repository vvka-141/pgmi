...
**Handler body construction (`p_handler_body`)**: Handler registration functions dynamically construct PostgreSQL functions using `format()` with a random dollar-quote boundary that is verified not to appear in the body:
