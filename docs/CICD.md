...
jobs:
  deploy:
    ...
    env:
      PGMI_VERSION: v0.12.1         # pin to a specific release tag
      DB_NAME: myapp
    steps:
...
- **Install script, pinned:**
  `curl -sSL https://raw.githubusercontent.com/vvka-141/pgmi/main/scripts/install.sh | PGMI_VERSION=v0.12.1 bash`
...
- **Go-based pipelines only:** `go install github.com/vvka-141/pgmi/cmd/pgmi@v0.12.1`
